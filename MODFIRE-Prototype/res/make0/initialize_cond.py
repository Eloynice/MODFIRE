...
for i in range(0, 1406):
	...
	f9.write("0,"+toWrite9 + "\n") #r
	toWrite9 = ''
	f10.write("0,"+toWrite10 + "\n") #
	toWrite10 = ''	
	f11.write("0,"+toWrite11 + "\n") #
	toWrite11 = ''
	f12.write("0,"+toWrite12 + "\n") #npv
	toWrite12 = ''
	f13.write("0,"+toWrite13 + "\n") #
	toWrite13 = ''	
	f14.write("0,"+toWrite14 + "\n") #
	toWrite14 = ''
	f15.write("0,"+toWrite15 + "\n") #rait
	toWrite15 = ''
	f16.write("0,"+toWrite16 + "\n") #
	toWrite16 = ''	
	f17.write("0,"+toWrite17 + "\n") #
	toWrite17 = ''
	f18.write("0,"+toWrite18 + "\n") #biodiversity
	toWrite18 = ''
	f19.write("0,"+toWrite19 + "\n") #
	toWrite19 = ''	
	f20.write("0,"+toWrite20 + "\n") #
	toWrite20 = ''
	f21.write("0,"+toWrite21 + "\n") #percrait
	toWrite21 = ''
	f22.write("0,"+toWrite22 + "\n") #
	toWrite22 = ''	
	f23.write("0,"+toWrite23 + "\n") #
	toWrite23 = ''
	f24.write("0,"+toWrite24 + "\n") #cashflow
	toWrite24 = ''
	f25.write("0,"+toWrite25 + "\n") #
	toWrite25 = ''	
	f26.write("0,"+toWrite26 + "\n") #
	toWrite26 = ''
	f27.write("0,"+toWrite27 + "\n") #cstock
	toWrite27 = ''
	f28.write("0,"+toWrite28 + "\n") #
	toWrite28 = ''	
	f29.write("0,"+toWrite29 + "\n") #
	toWrite29 = ''
