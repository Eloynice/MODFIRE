...
print('Enter name of pareto points file in Results folder: ')
print('Example: Paredes-ParetoPoints.csv')

x = input()

f = open("Results/"+str(x) , "r")


print('Enter name of non-pareto points file in Results folder: ')
print('Example: Paredes-NonParetoPoints.csv')

x2 = input()

f2 = open("Results/"+str(x2), "r")
